    ...
    public void ResistanceUp(AnimationEvent R)
    {
        ...
        switch (R.stringParameter)
        {
            ...
            case "magic_release":
                ...
                {
                    data_Center._BO_Ani_E.hiddenMethods.ReleasePreparedMagic_core(transform.position,transform.rotation, null, data_Center._MyBehaviorRunner.GetNowState().StateKey);
                };
