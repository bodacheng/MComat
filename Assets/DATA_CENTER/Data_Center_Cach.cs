...
public partial class Data_Center : MonoBehaviour
{
    ...
    public IEnumerator Step2InitializeByCach(string type, TextAsset Script, Element element, string personalMagic)
    {
        ...
        if (_MyBehaviorRunner.usingScript != Script)
        {
            ...
            yield return (
                Animation_Manger.PreloadPersonalAnims(ResourceDownLoad.BundleURL + "/animClips",type, toLoadSkillAnimsNames, personalMagic, element));
