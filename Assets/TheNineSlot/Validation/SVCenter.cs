...
{
    public static void StoneRemoveFromSlotToCell(StoneCell sourceCell, StoneCell boxcell, SKStoneItem item)
    {
        ...
        if (boxcell.GetItem() != null) // 如果把技能石从9宫格拖到技能背包的一个有石头的格子上，那么就直接把拖动中的技能石先从九宫格拔下来，接着让技能背包自动排序一下
        {
