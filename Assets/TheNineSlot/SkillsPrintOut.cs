...
namespace mainMenu
{
    ...
    public class SkillsPrintOut : MonoBehaviour
    {
        ...
        {
            CharConfig _watchingCharacterResourceInfo = MonstersConfigTable.GetCharacterResourceInfo(focusingResourceID);
        ...
        {
            CharConfig _watchingCharacterResourceInfo = MonstersConfigTable.GetCharacterResourceInfo(_watchingCharInfo.ResourceID);
