...
Shader "Malbers/Anisotropic/Circular"
{
	Properties
	{
		...
		_Cutoff( "Mask Clip Value", Float ) = 0.49
	...
	SubShader
	{
		...
		uniform float4 _AlbedoRGBOpacityA_ST;
		uniform float4 _SpecularTint;
		uniform sampler2D _Specular;
		uniform float _AnisotropyOffset;
		uniform float _AnisotropyFalloff;
		uniform float _Cutoff = 0.49;

		void surf( Input i , inout SurfaceOutputStandard o )
		{
			float2 uv_Normal = i.uv_texcoord * _Normal_ST.xy + _Normal_ST.zw;
			float3 NormalMap62 = UnpackScaleNormal( tex2D( _Normal, uv_Normal, float2( 0,0 ), float2( 0,0 ) ), _NormalAmount );
			o.Normal = NormalMap62;
			float2 uv_AlbedoRGBOpacityA = i.uv_texcoord * _AlbedoRGBOpacityA_ST.xy + _AlbedoRGBOpacityA_ST.zw;
			float4 tex2DNode1 = tex2D( _AlbedoRGBOpacityA, uv_AlbedoRGBOpacityA );
			...
			o.Smoothness = max( ( ( ( _SpecularTint * tex2D( _Specular, uv_Specular4 ) ) * pow( max( sin( radians( ( ( _AnisotropyOffset + nDotH24 ) * 180.0 ) ) ) , 0.0 ) , _AnisotropyFalloff ) ) * nDotL22 ) , float4( 0,0,0,0 ) ).r;
			o.Alpha = 1;
...
/*ASEBEGIN
Version=16200
608;182;1189;592;4543.872;203.4368;1.110366;True;True
Node;AmplifyShaderEditor.CommentaryNode;57;-3991.898,642.3001;Float;False;891.5006;424.4899;View Direction Vector;4;10;11;9;8;;1,1,1,1;0;0
Node;AmplifyShaderEditor.WorldSpaceCameraPos;6;-4002.567,671.6943;Float;True;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;47;-4441.228,56.32429;Float;False;Property;_NormalAmount;Normal Amount;6;0;Create;True;0;0;False;0;1;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;45;-4064.827,-44.64075;Float;True;Property;_Normal;Normal;5;1;[Normal];Create;True;0;0;False;0;None;b39a0994c7cead041aa6f80b6edceb29;True;0;True;bump;Auto;True;Object;-1;Derivative;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;25;-2303.304,176.503;Float;False;Property;_AnisotropyOffset;Anisotropy Offset;8;0;Create;True;0;0;False;0;-1;-0.35;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3;-1599.799,508.6237;Float;False;Property;_AnisotropyFalloff;Anisotropy Falloff;7;0;Create;True;0;0;False;0;64;155;1;256;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;43;-1315.204,-195.798;Float;False;Property;_SpecularTint;Specular Tint;4;0;Create;True;0;0;False;0;1,1,1,1;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMaxOpNode;31;-1251.303,254.8026;Float;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;4;-1387.158,-9.735434;Float;True;Property;_Specular;Specular;2;1;[NoScaleOffset];Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;65;-843.8511,160.7657;Float;False;22;nDotL;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;40;-1266.202,-631.3965;Float;False;Property;_AlbedoTint;Albedo Tint;1;0;Create;True;0;0;False;0;1,1,1,1;0.06603771,0.06603771,0.06603771,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;1;-1232.991,-407.2254;Float;True;Property;_AlbedoRGBOpacityA;Albedo (RGB) Opacity (A);0;0;Create;True;0;0;False;0;None;1e05e638de2d1ca49a870cea47e9f95d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;71;-580.2626,-531.0775;Float;True;62;NormalMap;1;0;OBJECT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMaxOpNode;54;-322.102,13.9297;Float;True;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;69;-3.98491,-356.0565;Float;False;True;2;Float;ASEMaterialInspector;0;0;Standard;Malbers/Anisotropic/Circular;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;Off;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.49;True;True;0;True;Opaque;;Background;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;1;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;2;5;False;-1;10;False;-1;0;5;False;-1;10;False;-1;0;False;-1;8;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;3;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;69;4;54;0
WireConnection;69;10;1;4
ASEEND*/
//CHKSM=6F99FBA28A40AB9893D838D9133D490EBBBF12ED