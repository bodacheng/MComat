	...
	public override void OnInspectorGUI()
	{
        ...
        if (state_folding_list = EditorGUILayout.Foldout(state_folding_list, "States"))
        {
            ...
            for (int i = 0; i < myScript.State_Transition_Set_List.Count; i++)
            {
                    ...
                    try
                    {
                        if (myScript.State_Transition_Set_List[i].casual_to_state_Sets != null)
                        {
                            for (int y = 0; y < myScript.State_Transition_Set_List[i].casual_to_state_Sets.Length; y++)
                            {
                                ...
                                myScript.State_Transition_Set_List[i].casual_to_state_Sets[y].casualToNextInputDepend = EditorGUILayout.Toggle("casualToNextInputDepend", myScript.State_Transition_Set_List[i].casual_to_state_Sets[y].casualToNextInputDepend);
                                if (myScript.State_Transition_Set_List[i].casual_to_state_Sets[y].casualToNextInputDepend)
                                {
								...
								myScript.State_Transition_Set_List[i].casual_to_state_Sets[y].SPLevel = (EX)EditorGUILayout.EnumPopup("SPLevel", myScript.State_Transition_Set_List[i].casual_to_state_Sets[y].SPLevel);
                ...
                myScript.State_Transition_Set_List[i].playerModeInputDepend = EditorGUILayout.Toggle("playmode input depend", myScript.State_Transition_Set_List[i].playerModeInputDepend);
                if (myScript.State_Transition_Set_List[i].playerModeInputDepend)
                {
                ...
                myScript.State_Transition_Set_List[i].SPLevel = (EX)EditorGUILayout.EnumPopup("SPLevel", myScript.State_Transition_Set_List[i].SPLevel);
