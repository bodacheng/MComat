...
public class Attack_And_Shield_Specification {
    ...
    public float AT_Damage_Magnification(damageType t)
    {
        switch(t)
        {
...
public class v_Damage
{
    ...
    public v_Damage() { }
    public v_Damage(int _damage, damageType damage_type,Vector3 force_direction,Vector3 damageHappenPoint,BO_Health toWho)
    {
    ...
    public v_Damage(int _damage, damageType damage_type, Vector3 force_direction, Vector3 damageHappenPoint, BO_Health toWho, BO_Marker_Manager fromWeapon)
    {
        this._damage = _damage;
        this.damage_type = damage_type;
        this.force_direction = force_direction;
