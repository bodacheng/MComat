...
Shader "Malbers/Fur"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			TEXTURE2D(_FurMap1);
			SAMPLER(sampler_FurMap1);
			TEXTURE2D(_Albedo);
			SAMPLER(sampler_Albedo);
			TEXTURE2D(_FurNormal);
			SAMPLER(sampler_FurNormal);
			TEXTURE2D(_BodyNormal);
			SAMPLER(sampler_BodyNormal);
			TEXTURE2D(_FurMap2);
			SAMPLER(sampler_FurMap2);
			TEXTURE2D(_Emission);
						 ...
						 ) : SV_Target
			{
				...
				float2 uv1_FurMap14 = IN.ase_texcoord8.xy;
				...
				float2 uv_Albedo1 = IN.ase_texcoord8.zw;
				...
				float2 uv1_FurNormal72 = IN.ase_texcoord8.xy;
				float3 unpack72 = UnpackNormalScale( SAMPLE_TEXTURE2D( _FurNormal, sampler_FurNormal, uv1_FurNormal72 ), _NormalPowerFur );
				unpack72.z = lerp( 1, unpack72.z, saturate(_NormalPowerFur) );
				float2 uv_BodyNormal5 = IN.ase_texcoord8.zw;
				float3 unpack5 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BodyNormal, sampler_BodyNormal, uv_BodyNormal5 ), _NormalPowerBody );
				...
				float2 uv1_FurMap212 = IN.ase_texcoord8.xy;
				...
				float2 uv_Emission58 = IN.ase_texcoord8.zw;
				

				float3 BaseColor = ( ( lerpResult129 * ( ( SAMPLE_TEXTURE2D( _Albedo, sampler_Albedo, uv_Albedo1 ) * _Tint ) * clampResult96 * lerpResult112 ) ) + ( _SpecularPower * temp_output_50_0 ) ).rgb;
				float3 Normal = FurNormal136;
				float3 Emission = ( tex2DNode4.b * ( ( SAMPLE_TEXTURE2D( _Emission, sampler_Emission, uv_Emission58 ) * _EmissionColor ) * _EmmisionPower ) ).rgb;
				float3 Specular = 0.5;
...
Node;AmplifyShaderEditor.ColorNode;113;352.5525,-1242.753;Inherit;False;Property;_ID;ID;8;0;Create;True;0;0;0;False;0;False;1,1,1,1;0.5849056,0.5815948,0.5815948,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;88;93.08142,-1919.39;Inherit;False;Property;_AO;AO;5;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0.509804;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;1;-64.162,-601.5174;Inherit;True;Property;_Albedo;Albedo;1;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;1;Header(Albedo);False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;4;-572.458,-140.7085;Inherit;True;Property;_FurMap1;Fur Map1 (A Height ID Root);19;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;-1;None;None;True;1;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;126;1709.871,-905.6517;Inherit;False;Property;_RootColor;Root Color;3;0;Create;True;0;0;0;False;0;False;1,1,1,1;0.5754716,0.5754716,0.5754716,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;130;1755.37,-720.1628;Inherit;False;Property;_TipColor;Tip Color;4;0;Create;True;0;0;0;False;0;False;1,1,1,1;0.8113207,0.8113207,0.8113207,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;72;-679.255,152.3974;Inherit;True;Property;_FurNormal;Fur Normal;14;3;[NoScaleOffset];[Normal];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;None;True;1;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;12;271.1712,942.56;Inherit;True;Property;_FurMap2;Fur Map1 (Spec AO Trans);20;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;-1;None;None;True;1;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=8F8B5A75981D85DB2FB0F38C630A8D7D3E968141