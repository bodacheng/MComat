	...
	public class MonsterOfPlayerDetailModel {
        ...
        public static CharDataInfo GetCharDataInfo(MonsterOfPlayerDetailModel accountCharInfo)
        {
            try
            {
                ...
                List<SkillStoneOfPlayerInfoModel> targets = MySkillStonesReader.GetEquipingStones(accountCharInfo.monsterOfPlayerId);
                ...
                charDataInfo._NineAndTwo = nineAndTwo;
                charDataInfo._NineAndTwo.SortNineAndTwo();
                return charDataInfo;
            }
            catch (Exception e)
            {
