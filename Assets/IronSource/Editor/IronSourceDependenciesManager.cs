...
public class IronSourceDependenciesManager : EditorWindow
{
    ...
    private IEnumerator SetProviderData()
    {
...
#endif
        {
            ...
            try
            {
                linksDictionary = IronSourceJSON.Json.Deserialize(linksJson) as Dictionary<string, object>;
                SDKInfoDictionary = IronSourceJSON.Json.Deserialize(SDKInfoJson) as Dictionary<string, object>;
            }
